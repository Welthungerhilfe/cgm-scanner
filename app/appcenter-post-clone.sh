...
sed -i '' "s|{APP_DATA_SECRET}|$APP_DATA_SECRET|g" $APP_CONSTANTS
...
echo "OAUTH_CLIENT_ID_SYRIA: $OAUTH_CLIENT_ID_SYRIA"
echo "OAUTH_REDIRECT_URL: $OAUTH_REDIRECT_URL"
echo "OAUTH_URL_SYRIA: $OAUTH_URL_SYRIA"
echo "OAUTH_SCOPE_SYRIA: $OAUTH_SCOPE_SYRIA"
echo "API_URL_SYRIA: $API_URL_SYRIA"
echo "APP_OAUTH_SYRIA_JSON: $APP_OAUTH_SYRIA_JSON"
echo "APP_CONSTANTS: $APP_CONSTANTS"