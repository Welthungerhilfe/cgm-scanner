...
public class AppConstants {
    ...
    public static final String AUTH_SANDBOX = "https://cgmb2csandbox.onmicrosoft.com/cgm-api/scannerapp";
   ...
   // public static final String API_URL_SANDBOX = "{API_URL_SANDBOX}/";
    public static final String API_URL_SANDBOX = "https://cgm-be-ci-dev-scanner-api.azurewebsites.net/api//";
