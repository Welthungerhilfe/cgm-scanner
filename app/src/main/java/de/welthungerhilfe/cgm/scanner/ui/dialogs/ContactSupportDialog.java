...
public class ContactSupportDialog extends Dialog {
    ...
    void onRecord(View record) {
        ...
        if (!recording) {
            ...
            audioFile = new File(AppController.getInstance().getPublicAppDirectory(), "voice_record.wav");
    ...
    public void attachFiles(File[] files) {
        ...
        zip = new File(AppController.getInstance().getPublicAppDirectory(), "report.zip");
    ...
    public static void show(BaseActivity activity, String type, String footer) {
        ...
        File screenshot = new File(AppController.getInstance().getPublicAppDirectory(), "screenshot.png");
