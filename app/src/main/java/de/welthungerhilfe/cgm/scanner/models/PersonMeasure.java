...
@Entity(tableName = DbConstants.TABLE_REL_PERSON_MEASURE,
        primaryKeys = { "personId", "measureId" },
        foreignKeys = {
...
public class PersonMeasure {
    ...
    public PersonMeasure(@NonNull String personId, @NonNull String measureId) {
    ...
    public void setMeasureId(@NonNull String measureId) {
        this.measureId = measureId;
    }
}
