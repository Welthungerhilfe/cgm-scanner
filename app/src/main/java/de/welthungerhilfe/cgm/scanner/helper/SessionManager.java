...
public class SessionManager {
    ...
    private final String KEY_USER_SYNC_TIMESTAMP = "key_user_sync_timestamp";
    ...
    public void setSyncTimestamp(long timestamp) {
        editor.putLong(KEY_USER_SYNC_TIMESTAMP, timestamp);

        editor.commit();
    }

    public long getSyncTimestamp() {
        return pref.getLong(KEY_USER_SYNC_TIMESTAMP, 0);
    }
}
